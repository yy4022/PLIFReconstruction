...
"""
This file is used for generating the datasets for testing the global model.
NOTE: testing datasets need to be preprocessed.
"""
...
np.save('data/Preprocessed_Data_old/Show/training_PLIF_data2.npy', training_PLIF_data)
np.save('data/Preprocessed_Data_old/Show/validation_PLIF_data2.npy', validation_PLIF_data)
np.save('data/Preprocessed_Data_old/Show/testing_PLIF_data2.npy', testing_PLIF_data)
...
with open('data/Preprocessed_Data_old/Show/training_PLIF_dataset2.pkl', 'wb') as file:
    pickle.dump(training_PLIF_dataset, file)

with open('data/Preprocessed_Data_old/Show/validation_PLIF_dataset2.pkl', 'wb') as file:
    pickle.dump(validation_PLIF_dataset, file)

with open('data/Preprocessed_Data_old/Show/testing_PLIF_dataset2.pkl', 'wb') as file:
...
np.save('data/Preprocessed_Data_old/Show/training_x_PIV_data2.npy', training_x_PIV_data)
np.save('data/Preprocessed_Data_old/Show/validation_x_PIV_data2.npy', validation_x_PIV_data)
np.save('data/Preprocessed_Data_old/Show/testing_x_PIV_data2.npy', testing_x_PIV_data)
...
with open('data/Preprocessed_Data_old/Show/training_x_PIV_dataset2.pkl', 'wb') as file:
    pickle.dump(training_x_PIV_dataset, file)

with open('data/Preprocessed_Data_old/Show/validation_x_PIV_dataset2.pkl', 'wb') as file:
    pickle.dump(validation_x_PIV_dataset, file)

with open('data/Preprocessed_Data_old/Show/testing_x_PIV_dataset2.pkl', 'wb') as file:
