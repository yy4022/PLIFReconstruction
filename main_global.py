...
if os.path.exists('./model/global_models/PIV_z/fullyCNN.pt'):
    fullyCNN = torch.load('./model/global_models/PIV_z/fullyCNN.pt')
...
if if_existing == True:
    train_loss_records = \
        np.append(train_loss_records, np.load('./result/global_results/PIV_z/train_loss_records.npy'))

    validation_loss_records = \
        np.append(validation_loss_records, np.load('./result/global_results/PIV_z/validation_loss_records.npy'))
...
for epoch in range(EPOCHS):
    ...
    if validation_loss < best_loss:
        ...
        torch.save(fullyCNN, './model/global_models/PIV_z/fullyCNN.pt')

# save loss records of training and validation process
np.save("./result/global_results/PIV_z/train_loss_records.npy", train_loss_records)
np.save("./result/global_results/PIV_z/validation_loss_records.npy", validation_loss_records)
